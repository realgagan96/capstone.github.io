        ...
        {/*----------------------------- carousel Start -----------------------------*/}
          ...
          <div className="description" data-aos="fade-down">
              ...
              <p>
                ...
                non temporibus incidunt omnis neque. Iusto quidem aliquid itaque
                fuga saepe aperiam ipsam! Error fugiat vel tempora quibusdam
                accusantium officia aut quaerat, dolorum consequuntur corrupti
                quia eos adipisci sed minus sint! A sint sapiente minus at neque
                repellendus laboriosam expedita debitis!
              </p>
          ...
          <div className="qout_main container" data-aos="fade-down">
            ...
            <div id="history" className="py-2">
              <div className="leftside">
                <h5 style={{textAlign:"justify", marginRight:'.5rem'}}>"{currentCard.coute}"</h5>
              </div>
              <div className="rightside">
                <div
                  className="card"
                  style={{ overflow: "hidden", width: "300px", borderRadius:".5rem", boxShadow:".2rem .2rem .3rem rgba(0,0,0,0.3)" }}
                >
                  <img
                  ...
                  <div
                    className="container"
                    style={{ textAlign: "start", width: "100%" , padding:'.7rem .5rem' }}
                  >
                    <h4>
        ...
        <section id="contact" className="row contact_section">
          ...
          {/* <Flip left cascade> */}
            {/* <div className="form_container"> */}
              <form className="form" ref={form} onSubmit={sendEmail} data-aos="fade-down">
                {/* <div className="form"> */}
                <div className="row" >
                  <h1>Get in Touch</h1>
